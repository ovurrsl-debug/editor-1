...
type EditorState = {
  ...
  movingNode: ItemNode | WindowNode | DoorNode | RoofNode | RoofSegmentNode | RackNode | WarehouseDoorNode | WallNode | ColumnNode | null
  setMovingNode: (
    node: ItemNode | WindowNode | DoorNode | RoofNode | RoofSegmentNode | RackNode | WarehouseDoorNode | WallNode | ColumnNode | null,
  ) => void
...
const useEditor = create<EditorState>()(
  persist(
    (set, get) => ({
      ...
      movingNode: null as ItemNode | WindowNode | DoorNode | RoofNode | RoofSegmentNode | WallNode | ColumnNode | null,
